...
class MaterialesEntregados(models.Model):
    ...
    nommbreInspector = models.CharField(max_length=50, null=False, blank=False)
    apellidoInspector = models.CharField(max_length=50, null=False, blank=False)
    nombreSoldador = models.CharField(max_length=50, null=False, blank=False)
    apellidoSoldador = models.CharField(max_length=50, null=False, blank=False)
    creado = models.DateTimeField(auto_now=True)
